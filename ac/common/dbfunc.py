...
from ac.common import error_logics as errhand
...
def mydbopncon():
    ...
    try:
        ...
        #conn_string = "host='ac.c5eo06dso01d.ap-south-1.rds.amazonaws.com' dbname='nawalcube' user='nawalcube' password='Nirudhi1!'"
